...
<div class="jumbotron">
  ...
  <p class="lead">For Sprue Entrance Diameter = <?php echo $vc;?> (mm) .</p>
  <hr class="my-4">
  <p>Height of pouring basin = <?php echo $h;?> (mm) ,  Diameter of pouring basin = <?php echo $d;?> (mm) 
  <a class="btn btn-primary btn-lg" href="s2_marathi.html" role="button">Calculate Again</a>
</div>
</div>
