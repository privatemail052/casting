...
<div class="jumbotron">
  ...
  <p class="lead">For Volume of Casting = <?php echo $a;?> (mm3), Surfce Area = <?php echo $b;?> (mm2), Mold Constant = <?php echo $d;?>.</p>
  <hr class="my-4">
  <p>Solidification Time = <?php echo $g;?> Min</p>
  <a class="btn btn-primary btn-lg" href="time1_marathi.html" role="button">Calculate Again</a>
</div>
</div>
